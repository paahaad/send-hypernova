      ...
      <div className="w-full h-14 max-w-screen-2xl mx-auto px-4 md:px-8 lg:px-12 flex items-center justify-between">
        <div className="flex items-center gap-2 md:gap-6">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Link href="/presales" className="font-medium transition-colors hover:text-foreground/80">
              Presales
            </Link>
            <Link href="/my-tokens" className="font-medium transition-colors hover:text-foreground/80">
              My Tokens
            </Link>
          </nav>
        </div>
          ...
          {isConnected ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="flex items-center gap-2 text-xs h-8 border-neutral-700">
                  <Wallet className="h-3 w-3" />
                  <span className="hidden sm:inline-block">0x1a2b...3c4d</span>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="bg-background border-neutral-800">
            ...
            <Button onClick={() => setIsConnected(true)} size="sm" className="h-8 text-xs">
              Connect
            </Button>
          )}
